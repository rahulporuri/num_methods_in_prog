...
main(void)
{
	...
	A_data = (double **) malloc(N* sizeof(double*));
	/*for each row address, we need to allocate Ncol times doubles*/
	for(i = 0; i < N; i++)
	{
		A_data[i] = (double *) malloc(N * sizeof(double));
	}
